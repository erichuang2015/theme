...
function theme_main_visual( $name = '', $post_id = 0 )
{
	...
	get_template_part( 'template-parts/main-visuals/main-visual', $name );
}
 ...
 */
function theme_main_visuals_load_json( $paths ) 
{
    $paths[] = get_theme_file_path( 'acf-json/main-visuals' );
    
    return $paths;
}

add_filter( 'acf/settings/load_json', 'theme_main_visuals_load_json' );
